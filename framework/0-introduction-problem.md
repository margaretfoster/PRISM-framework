...
PRISM draws on several intellectual traditions that develop pathways for causal and inferential reasoning under data constraints.  The framework draws on the intellectual scaffolding developed for causal inference (Pearl, Green); process tracing (Bennett and Checkel 2012, 2015, Ricks and Liu 2015); machine learning, and multi-method social science (Seawright 2016).  
